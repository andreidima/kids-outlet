    ...
    <div class="col-lg-12 px-2 mb-0">
        ...
        <div class="row py-2 justify-content-center">
            <div class="col-lg-8 d-flex justify-content-center">
                <button type="submit" class="btn btn-primary text-white btn-sm me-2 rounded-3">{{ $buttonText }}</button>
                <a class="btn btn-secondary btn-sm rounded-3" href="{{ Session::get('norme_lucrate_return_url') }}">Renunță</a>
            </div>
        </div>
    </div>
</div>
