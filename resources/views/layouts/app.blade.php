            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        @php
                            $userRolesArray = auth()->user()->roles->pluck('role')->toArray();
                        @endphp
                        @if (in_array("superadmin", $userRolesArray) || in_array("admin", $userRolesArray))
                        ...
                        @elseif (in_array("normeLucrate", $userRolesArray))
                            <li class="nav-item me-3 dropdown">
                                <a class="nav-link active dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    <i class="fas fa-clipboard-list me-1"></i>Norme lucrate
                                </a>
